...
class ChangeAmountTest {
	...
	@Test
	void testChangeToDisplay() throws ServerOfflineException, ItemNotFoundException, CustomerDiscountIdNotFoundException, CustomerIdNotFoundException, Exception {
		view.totalRevenuePrint();
		String output = printoutBuffer.toString();
		String expectedOutput = "Banknots to give";
